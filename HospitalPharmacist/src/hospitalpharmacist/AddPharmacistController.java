 ...
 * @author Andre Kelvin
 */
public class AddPharmacistController implements Initializable /*extends AddStaff*/ {
...
//    }
    ...
    private String comma, pharName, phone, address, city, degree, email, salary;
    ...
    private void saveAction() {
        try {
            ...
            if (address.isEmpty() || city.isEmpty() || degree.isEmpty() || pharName.isEmpty() || email.isEmpty() || phone.isEmpty() || salary.isEmpty()
                ...
                ps = HospitalDB.getCon().prepareStatement("Insert Into Pharmacist (NAME, DATE_OF_BIRTH, GENDER, ADDRESS, CITY, PHONE, MARITAL_STATUS,"
                ...
                ps.setString(13, System.getProperty("user.home") + File.separator + "PharmacistImage" + File.separator + imageFile.getName());
                ps.executeUpdate();

                //Save the Actual Image to PharmacistImage File
                input = new FileInputStream(imageFile);
                output = new FileOutputStream(System.getProperty("user.home") + File.separator + "PharmacistImage" + File.separator + imageFile.getName());
