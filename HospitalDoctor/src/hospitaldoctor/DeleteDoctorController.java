 ...
 * @author Andre Kelvin
 */
public class DeleteDoctorController /*extends DeleteStaff*/ {
...
//    }
    ...
    public void getSelectedDocName(String selectedDocName) {
        this.selectedDocName = selectedDocName;
        label.setText("Are your sure you want to Delete " + selectedDocName + "?");
    }

    public void getDocImageFile(File docImageFile) {
        this.docImageFile = docImageFile;
    }

    public void getDocID(int selectedDocID) {
    ...
    private void yesAction() {
        try {
            ps = HospitalDB.getCon().prepareStatement("Delete From Doctor Where Name=? and ID=?");
            ps.setString(1, selectedDocName);
            ps.setInt(2, selectedDocID);
            ps.executeUpdate();

            //Delete the Selected Doctors Image
            docImageFile.delete();
