 ...
 * @author Andre Kelvin
 */
public class AddDoctorController implements Initializable /*extends AddStaff*/{
...
//    }
    ...
    private String comma, docName, phone, address, city, degree, email, salary;
    ...
    private void saveAction() {
        try {
            ...
            if (address.isEmpty() || city.isEmpty() || degree.isEmpty() || docName.isEmpty() || email.isEmpty() || phone.isEmpty() || salary.isEmpty()
                ...
                ps = HospitalDB.getCon().prepareStatement("Insert Into Doctor (NAME, DATE_OF_BIRTH, GENDER, ADDRESS, CITY, PHONE, MARITAL_STATUS,"
                ...
                ps.setString(13, System.getProperty("user.home") + File.separator + "DoctorImage" + File.separator + imageFile.getName());
                ps.executeUpdate();

                //Save the Actual Image to DoctorImage File
                input = new FileInputStream(imageFile);
                output = new FileOutputStream(System.getProperty("user.home") + File.separator + "DoctorImage" + File.separator + imageFile.getName());
